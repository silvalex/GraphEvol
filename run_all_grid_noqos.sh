...
for i in 1 2 5
do
  qsub -t 1-$NUM_RUNS:1 graph_ops_noqos.sh ~/workspace/wsc2008/Set0${i}MetaData 2008-graph-noqos${i} graph-evol-noqos.params false true problem.xml taxonomy.xml services-output.xml;
done
